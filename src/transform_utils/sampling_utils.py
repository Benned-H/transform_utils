...
def generate_alternating_centered_angles(center_rad: float, num_angles: int = 8) -> list[float]:
    ...
    and alternates by stepping positively and negatively away from the center (in radians).
    ...
    :param num_angles: Total number of angle samples (in radians) to generate
